...
namespace nvvk {
    ...
    public:
        ...
        // In particular, you must make sure they are still valid and not being modified when the BLAS is built or
        // updated.
        struct BlasInput {
        ...
        void buildTlas(
            size_t num_instances, void *instance_data, size_t sizeof_instance,
            VkBuildAccelerationStructureFlagsKHR flags = VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT_KHR,
    ...
    public:
        ...
        void buildTlas(const std::vector<VkAccelerationStructureInstanceKHR> &instances,
                       vk::BuildAccelerationStructureFlagsKHR flags, bool update = false) {
