...
void VulkanEngine::upload_to_vma_allocation(const void *src, size_t size, const AllocatedBuffer &dst_allocation,
                                            size_t dst_offset) const {
    run_with_mapped_memory(_allocator, dst_allocation.allocation,
